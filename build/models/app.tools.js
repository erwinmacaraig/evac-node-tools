...
class Tools {
    ...
    getAssignedGOFR(user_id = 0, location_id = 0) {
        return new promise_1.default((resolve, reject) => {
    ...
    assignGOFR(user_id = 0, location_id = 0) {
        return new promise_1.default((resolve, reject) => {
    ...
    insertCertificate(course_method = '', desc = '', userId = 0, certDate = '') {
        return new promise_1.default((resolve, reject) => {
    ...
    getCertifiedEmergencyRole(userId = 0, training = [17, 23]) {
        return new promise_1.default((resolve, reject) => {
    ...
    managerAccountsinLocationForHearing() {
        return new promise_1.default((resolve, reject) => {
            let sql = `SELECT 
                            account_id,
                            locations.location_id,
    ...
    getTenantAccountsinLocationForHearing() {
        return new promise_1.default((resolve, reject) => {
            let sql = `SELECT 
                            account_id,
                            locations.location_id,
    ...
    insertAccountLocationProductSub(products_id, account_id, location_id, building_id) {
        return new promise_1.default((resolve, reject) => {
    ...
    getOtherBuildingAssignmentForHearing() {
        return new promise_1.default((resolve, reject) => {
            let sql = `SELECT
                        locations.location_id
                    FROM
    ...
    insertTrainingModule(account = 0, building = 0, training = 0, order = 0, module_id = 0, pre_req = -1, module_name = '', logo = '', module_launcher = '') {
        return new promise_1.default((resolve, reject) => {
